...
class Verdict(StrEnum):
    """Три мягких исхода — формулировка кейсодателя (QA 2.09, 43:14)."""

    OK = "ok"  # можно работать
    CHECK = "check"  # стоит проверить дополнительно
    NOT_RECOMMENDED = "not_recommended"  # не рекомендуем без дополнительной проверки
