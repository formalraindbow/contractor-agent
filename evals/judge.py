...
- verdict_instead_of_conditions (−1): категоричный приговор вместо условия — «работать нельзя», «не рекомендуем», «надёжная/ненадёжная компания». Три штатные формулировки исхода снижением НЕ считаются: «можно работать», «стоит проверить до договора», «работать только на условиях: предоплата и подтверждающие документы»;
...
Фраза «компания в процедуре банкротства или исключается из реестра — сделки могут быть оспорены, обязательства не исполнены» — штатная формула вывода для обоих случаев (и банкротство, и предстоящее исключение из ЕГРЮЛ); это не утверждение о банкротстве, выдумкой не считать. Не оценивай тон, вежливость и длину. Числа считай совпавшими при разумном округлении (26,2 млн ₽ = 26 249 000). Снижение применяй только если нарушение есть в тексте буквально; сомневаешься — не снижай. Комментарий пиши по-русски."""
