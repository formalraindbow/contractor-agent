...
- courts_without_role_period_field (−2): названо число судебных дел без роли (истец/ответчик), статуса или периода и без поля-источника;
...
- verdict_instead_of_conditions (−1): категоричный вердикт вместо действия для пользователя;
