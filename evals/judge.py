...
- label_recomputed_or_explained (−2): агент объяснил, почему метка банка такая, или пересчитал её (расшифровать шкалу — можно);
...
Не оценивай тон, вежливость и длину. Числа считай совпавшими при разумном округлении (26,2 млн ₽ = 26 249 000)."""
