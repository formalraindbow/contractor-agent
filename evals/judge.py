...
- verdict_instead_of_conditions (−1): категоричный приговор вместо условия — «работать нельзя», «не рекомендуем», «надёжная/ненадёжная компания». Три штатные формулировки исхода снижением НЕ считаются: «можно работать», «нужна дополнительная проверка», «есть существенные риски»;
